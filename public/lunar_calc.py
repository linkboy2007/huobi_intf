...
class ZhDate():
    ...
    def chn_month_day(self):
        lunar_str = str(self.lunar_month).zfill(2) + '-' + str(self.lunar_day).zfill(2)
        return lunar_str    
...
if __name__ == '__main__':
    print(ZhDate.today().chn_month_day())
    print((ZhDate.today() + 20).chn_month_day())